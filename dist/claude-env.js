 ...
 */
export function claudeChildEnv(parentEnv, anthropicBaseUrl) {
    const childEnv = {
        ...parentEnv,
 ...
 */
export function claudeNativeOneMillionContextEnabled(parentEnv) {
    return !envFlagEnabled(parentEnv.CLAUDE_CODE_DISABLE_1M_CONTEXT);
}
//# sourceMappingURL=claude-env.js.map